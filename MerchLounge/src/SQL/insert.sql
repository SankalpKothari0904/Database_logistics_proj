...
insert into order values(4001,102,'23-04-2023');
...
insert into orderDesc values(1,9029,4001,2,'D','Out for Delivery');
...
insert into orderDesc values(5,9038,4003,'R','Collected, refund Processing');
...
insert into shipments values (1,501,4001,"Air");
