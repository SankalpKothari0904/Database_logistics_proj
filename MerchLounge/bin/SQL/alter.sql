ALTER TABLE orders add constraint fk_cust_order FOREIGN KEY (customerID) REFERENCES customer(customerID) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE orderDesc add constraint fk_orderdesc_order FOREIGN KEY (orderID) REFERENCES orders(orderID) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE shipments add constraint fk_shipment_order FOREIGN KEY (orderID) REFERENCES orders(orderID) ON DELETE CASCADE ON UPDATE CASCADE;